...
https://github.com/ankitdandiwala/Airbnb-Booking-Analysis/blob/main/EDA_Airbnb_Booking_Analysis.ipynb

# **Problem Statement**

**This exploratory data analysis project aims to uncover valuable insights from the Airbnb booking dataset, enabling informed decision for the client**
